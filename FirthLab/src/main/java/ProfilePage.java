...
public class ProfilePage {
    ...
    public void checkHometown(String expectedHometown)
    {
        ...
        Assert.assertTrue(hometown.getText().startsWith(expectedHometown));
    }
    ...
    public void checkName(String expectedName)
    {
        ...
        Assert.assertTrue(name.getText().startsWith(expectedName));
    }
    ...
    private class Options
    {
        ...
        {
            this.hometown = (new WebDriverWait(driver, 10))
        ...
        {
            this.name = (new WebDriverWait(driver, 10))
