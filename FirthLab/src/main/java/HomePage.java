...
public class HomePage {
    ...
    public void checkSuccessfulProfileTransition()
    {
        Assert.assertTrue(successfulProfileTransition);
    }

    public void checkSuccessfulHomePageLeaving()
    {
        Assert.assertTrue(successfulHomePageLeaving);
    }
